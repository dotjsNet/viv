        ...
        if ($charge) {
            ...
            if ($stop == 0) {
                ...
                if ($is_pro == 1) {
                    ...
                    if ($mysqli) {
//create invoice
                        $invoiceID  = Wo_InvoiceData($wo['user']['user_id'],$proTitle,$amount2,$pro_type,$amount2,"New ".$proTitle." badge is bought",1,$charge->id,$charge->source->customer,$charge->source->name);
